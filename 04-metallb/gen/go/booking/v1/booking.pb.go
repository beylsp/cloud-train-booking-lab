...
const file_booking_v1_booking_proto_rawDesc = "" +
	...
	"\rCreateBooking\x12 .booking.v1.CreateBookingRequest\x1a!.booking.v1.CreateBookingResponseB\xa7\x01\n" +
	"\x0ecom.booking.v1B\fBookingProtoP\x01Z>cloud-train-booking-lab/04-metallb/gen/go/booking/v1;bookingv1\xa2\x02\x03BXX\xaa\x02\n" +
	"Booking.V1\xca\x02\n" +
